...
BOOL cTiles::Create(cGraphics *Graphics, int NumTextures)
{
  ...
  m_Widths  = new int[m_NumTextures];
  m_Heights = new int[m_NumTextures];
  m_Columns = new int[m_NumTextures];
...
BOOL cTiles::Load(int TextureNum, char *Filename,
...
BOOL cTiles::Free(int TextureNum)
{
  // Error checking
  if(TextureNum >= m_NumTextures || m_Textures == NULL)
    return FALSE;
...
int cTiles::GetWidth(int TextureNum)
{
  // Error checking
...
int cTiles::GetHeight(int TextureNum)
{
  // Error checking
...
int cTiles::GetNum(int TextureNum)
{
  // Error checking
  if(TextureNum >= m_NumTextures || m_Textures == NULL ||
...
BOOL cTiles::Draw(int TextureNum, int TileNum,
